...
const portfolio = () => {
  return (
    <>
      ...
      <Searchsec name={"Portfolio"} pera={"Elevate your professional portfolio with our cutting-edge website template. Download it for free and make a lasting impression!"} />
      <Category />
